...
namespace CrowdControl
{
    ...
    public static class CustomGUIMessages
    {
        private static readonly Dictionary<string, Dictionary<Language, string>> flagMessages = new()
        {
            {
                "ForceUseCash", new()
                {
        ...
        private static readonly List<string> activeMessages = new();
        
        public static void Update()
        {
            UpdateActiveMessages();
            DrawGUI(); //ymmv on how good of an idea this is
        }

        public static void UpdateActiveMessages()
        {
        ...
        {
            GUIStyle guiStyle = new() { fontSize = 14 };
            int yOffset = 0;
